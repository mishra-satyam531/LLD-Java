...
public class Main {
    public static void main(String[] args) {
       Vehicle hondaCity = new Vehicle(1, "DL03-AB-1234", VehicleType.CAR, Status.ACTIVE, 2022, 5000);
        ...
        VehicleInventoryManagement inventory = new VehicleInventoryManagement(vehicleMap);
        
        Location location = new Location("Sector 62", 201309, "Noida", "UP", "India");

        List<Reservation> storeReservations = new ArrayList<>();
        Store store = new Store(101, inventory, storeReservations, location);
